...
async function processWithGemini(imageResponse) {
  ...
  try {
    // Call the API with the exact structure from the example
    ...
    // Extract the image from the response following the example
    if (result.candidates && result.candidates[0] && result.candidates[0].content) {
      ...
      console.log("Unexpected response structure:", JSON.stringify(result).substring(0, 200) + "...");
    }
